...
import { ScrollReveal } from "@/components/resume/ScrollReveal";
  ...
  return (
    <main className="relative">
      ...
      <section id="about" className="pt-16">
        <div className="mx-auto flex max-w-4xl flex-col items-center gap-10 px-5 pb-8 pt-16 sm:flex-row sm:items-start sm:gap-12">
      ...
      <section id="resume" className="relative mx-auto max-w-4xl px-5 py-14 pt-24">
        <ScrollReveal>
